...
export interface MyERC721 extends BaseContract {
  ...
  chhangeOwner: TypedContractMethod<
  ...
  mint: TypedContractMethod<
    [_to: AddressLike, tokenid: BigNumberish, _uri: string],
    [boolean],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "chhangeOwner"
  ): TypedContractMethod<[_newowner: AddressLike], [boolean], "nonpayable">;
  getFunction(
